...
def evaluate_knn_for_multiple_k(X_train, y_train, X_test, k_values=[1, 3, 5, 7]):
    """Evaluates k-NN classifier for multiple k values and plots results."""
    for k in k_values:
        classify_and_plot(X_train, y_train, X_test, k)
...
evaluate_knn_for_multiple_k(X_train, y_train, X_test)
